...
- Interner Forge-Link (Export soll neutralisieren): `https://git.example.com/GRO/Claude-Usage-Dashboard`
...
- **feat → main:** kontrollierter PR-Merge von `feat/proxy-logs` zur Forge-`main` (Pipeline-/Prozess-Check).
